...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Devaraju K G — Python Developer · AI · Blockchain" },
      { name: "description", content: "Portfolio of Devaraju K G, MCA student and Python developer specializing in AI, Blockchain and Data Analytics." },
      { name: "author", content: "Devaraju K G" },
      { property: "og:title", content: "Devaraju K G — Python Developer · AI · Blockchain" },
      { property: "og:description", content: "Building secure, intelligent and data-driven software solutions." },
